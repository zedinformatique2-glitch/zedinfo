...
export const ar = {
  ...
  productForm: {
    ...
    descAr: "الوصف (عربي)",
    price: "السعر (د.ج)",
    comparePrice: "السعر قبل التخفيض (د.ج)",
    comparePriceHint: "اتركه فارغًا أو 0 لإخفاء التخفيض. عند الإدخال، يظهر المنتج في قسم العروض ويعرض شارة −X٪ والسعر المشطوب.",
    stock: "المخزون",
    images: "الصور",
    ...
    featured: "منتج مميز",
    requiresBuild: "يتطلب شراء مع تجميعة كاملة",
    requiresBuildHint: "عند التفعيل، يرى العميل تنبيهًا بأن هذا المنتج لا يُباع منفردًا",
    requiresBuildSection: "خيارات البيع",
    requiresBuildNoteFr: "ملاحظة مخصصة بالفرنسية (اختياري)",
    requiresBuildNoteAr: "ملاحظة مخصصة بالعربية (اختياري)",
    requiresBuildNoteEn: "ملاحظة مخصصة بالإنجليزية (اختياري)",
    requiresBuildNoteHelp: "اتركه فارغًا لاستخدام النص الافتراضي للموقع",
    save: "حفظ",
    saving: "جاري الحفظ...",
    cancel: "إلغاء",
